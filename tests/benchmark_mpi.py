...
"""
    ...
    for i in range(ncell):
      cell_string ="""%d 20.0  1e+04 10.0  10.0
""" % ( i)
      f.write(cell_string)
    f.close()
    ...
    for i in range(nrun):
        ...
        p = Popen('./test_astro_mpi.sh', stderr = PIPE,env=new_env)
    ...
    user_avg /= nrun
    sys_avg /= nrun
    real_avg_cell = real_avg /ncell
    user_avg_cell =  user_avg /ncell
    sys_avg_cell =  sys_avg /ncell

 
    print "=========================================="
    print "Benchmark results:"
    print "real: %6.3fs  user: %6.3fs  sys: %6.3fs" % (real_avg, user_avg, sys_avg)
    print "real_cell: %6.3fs  user_cell: %6.3fs  sys_cell: %6.3fs" % (real_avg_cell, user_avg_cell, sys_avg_cell)
    print "=========================================="    
